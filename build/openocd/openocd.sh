#!/bin/sh
#
# Unified OpenOCD script for KubOS
#
# This script is supposed to be called from the KubOS make system,
# as it depends on certain environment variables. An OpenOCD
# configuration file must be present in a the board's dist folder.
#
